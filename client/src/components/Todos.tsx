...
export class Todos extends React.PureComponent<TodosProps, TodosState> {
  ...
  handlePhoneChange = (event: React.ChangeEvent<HTMLInputElement>) => {
    this.setState({ newPhoneNo: event.target.value })
  }
    ...
    return (
      <Grid.Row>
        <Grid.Column width={16}>
          ...
          />
          <Input fluid actionPosition="left" placeholder="Phone Number" onChange={this.handlePhoneChange}/>
        </Grid.Column>
        <Grid.Column width={16}>
          <Divider />
        </Grid.Column>
